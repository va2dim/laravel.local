...
-->
            ...
            <div class="col-lg-2">
                <input class="form-control" type="date" id="date" name="publicate_at" placeholder="Дата публикации" value="">
            </div>

            <label for="author" class="col-lg-1 control-label">Автор</label>
            <div class="col-lg-11">
                <input class="form-control" type="text" id="author" name="author" placeholder="Автор" value="">
            </div>

            <label for="category" class="col-lg-1 control-label">Категория/жанр</label>
            <div class="col-lg-11">
                <input class="form-control" type="text" id="category" name="category" placeholder="Жанр/категория" value="">
            </div>
